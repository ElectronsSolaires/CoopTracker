...
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '4825', 'PREFIX':'T0003', 'SNAME': 'Lamoricière', 'LNAME': 'Ecole élémentaire Lamoricière', 'TYPE':'Ecole élémentaire', 'DATEINST': datetime(2021, 8, 16, 0,0,0), 'CITY':'Paris, 75012', 'LAT':'48.844902','LON':'2.412325', 'PeakPW':'30'}, ignore_index=True)
...
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org', 'EPID': '5442', 'PREFIX':'T0102', 'SNAME': 'NATIVITE_75012', 'LNAME': 'Nativité', 'TYPE':'HLM', 'DATEINST': datetime(2022, 2, 14, 0,0,0), 'CITY':'Paris, 75012','LAT':'48.835225','LON':'2.386057', 'PeakPW':'36.0'}, ignore_index=True)
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '5321', 'PREFIX':'T0106', 'SNAME': 'Evangile', 'LNAME': "Ecole élémentaire de l'Evangile", 'TYPE':'Ecole élémentaire', 'DATEINST': datetime(2022, 2, 12, 0,0,0), 'CITY':'Paris, 75018', 'LAT':'48.895577','LON':'2.3629', 'PeakPW':'35.7'}, ignore_index=True)
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '5322', 'PREFIX':'T0105', 'SNAME': 'Le Cargo', 'LNAME': "Hôtel d'entreprises Le Cargo", 'TYPE': "Hôtel d'entreprises", 'DATEINST': datetime(2022, 2, 17, 0,0,0), 'CITY':'Paris, 75019', 'LAT':'48.88','LON':'2.38', 'PeakPW':'113.78'}, ignore_index=True)