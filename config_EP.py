...
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '5635', 'PREFIX':'T0107', 'SNAME': 'Panoyaux', 'LNAME': "HLM Panoyaux", 'TYPE': "HLM", 'DATEINST': datetime(2022, 4, 19, 0,0,0), 'CITY':'Paris, 75020', 'LAT':'48.87','LON':'2.39', 'PeakPW':'9.0'}, ignore_index=True)
