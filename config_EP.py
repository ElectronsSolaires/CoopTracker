...
# Electrons Solaires
df_sites = df_sites.append({'COOP':'Electrons Solaires', 'COOPSITE':'https://www.electrons-solaires93.org', 'EPID': '1639', 'PREFIX':'WD', 'SNAME': 'Waldeck-Rousseau', 'LNAME': 'Ecole Waldeck-Rousseau', 'TYPE':'Ecole élémentaire', 'DATEINST': datetime(2021, 2, 10, 0,0,0), 'CITY':'Les Lilas', 'LAT':'48.88189202996699','LON':'2.41970629674966', 'PeakPW':'37.4'}, ignore_index=True)
