...
#df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '5321', 'PREFIX':'EN10', 'SNAME': 'Evangile', 'LNAME': "Ecole élémentaire de l'Evangile", 'TYPE':'Ecole élémentaire', 'DATEINST': datetime(2022, 2, 08, 0,0,0), 'CITY':'Paris, 75018', 'LAT':'48.895577','LON':'2.3629', 'PeakPW':'35.7'}, ignore_index=True)
#df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '5322', 'PREFIX':'EN11', 'SNAME': 'Le Cargo', 'LNAME': "Hôtel d'entreprises Le Cargo", 'TYPE': "Hôtel d'entreprises", 'DATEINST': datetime(2022, 1, 12, 0,0,0), 'CITY':'Paris, 75019', 'LAT':'48.88','LON':'2.38', 'PeakPW':'113.78'}, ignore_index=True)
