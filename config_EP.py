...
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '8932', 'PREFIX':'T0201', 'SNAME': 'RungisA8', 'LNAME': "Copro Urban Coop", 'TYPE': "Copro", 'DATEINST': datetime(2023, 11, 6, 0,0,0), 'CITY':'Rungis, 94150', 'LAT':'48.74541','LON':'2.34434', 'PeakPW':'52.1'}, ignore_index=True)
df_sites = df_sites.append({'COOP':"EnerCit'IF", 'COOPSITE':'https://enercitif.org','EPID': '9104', 'PREFIX':'T0202', 'SNAME': 'RungisA7', 'LNAME': "Copro Urban Coop", 'TYPE': "Copro", 'DATEINST': datetime(2023, 11, 21, 0,0,0), 'CITY':'Rungis, 94150', 'LAT':'48.7453241860286','LON':'2.34498144868049', 'PeakPW':'45.0'}, ignore_index=True)
...
df_sites = df_sites.append({'COOP':"Energie Partagee", 'COOPSITE':'https://energie-partagee.org/','EPID': '856', 'PREFIX':'HP', 'SNAME': 'Pajol', 'LNAME': "Halle Pajol", 'TYPE': "ZAC", 'DATEINST': datetime(2018, 4, 1, 0,0,0), 'CITY':'Paris, 75018', 'LAT':'48.888352','LON':'2.362944', 'PeakPW':'465.1'}, ignore_index=True)
df_sites = df_sites.append({'COOP':"Energie Partagee", 'COOPSITE':'https://energie-partagee.org/','EPID': '857', 'PREFIX':'QT', 'SNAME': 'Quintessence', 'LNAME': "Copro Quintessence", 'TYPE': "Copro", 'DATEINST': datetime(2018, 3, 1, 0,0,0), 'CITY':'Paris, 75017', 'LAT':'48.890868','LON':'2.316446', 'PeakPW':'95.6'}, ignore_index=True)
df_sites = df_sites.append({'COOP':"Energie Partagee", 'COOPSITE':'https://www.sipenr.fr/EnR-Juine-et-Renarde','EPID': '8267', 'PREFIX':'ENRJR', 'SNAME': 'Etrechy', 'LNAME': 'Ferme Solaire Etrechy', 'TYPE':'Ferme Solaire', 'DATEINST': datetime(2024, 2, 12, 0,0,0), 'CITY':'Etrechy', 'LAT':'48.502044','LON':'2.203791', 'PeakPW':'4745.5'}, ignore_index=True)
